        ...
        <AlertDialog>
            ...
            <AlertDialogContent className="max-w-lg">
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction className="bg-green-800 hover:bg-green-700" onClick={handleCreateJob} disabled={isPending || !title.trim()}>{isPending ?"Creating....":"Create Assessment"}</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    );
